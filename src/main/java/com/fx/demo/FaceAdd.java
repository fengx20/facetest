...
import com.fx.demo.ImageBase64Util;
...
public class FaceAdd {
    ...
    public static String add() {
        ...
        try {
            String image64 = ImageBase64Util.getImageStr("C:/Users/Administrator/Desktop/fx.jpg");
            Map<String, Object> map = new HashMap<>();
            map.put("image", image64);
            map.put("group_id", "test2");  //新的添加，已存在的直接存
            map.put("user_id", "test3");   //新的添加，已存在的直接存
            map.put("user_info", "傻子");
